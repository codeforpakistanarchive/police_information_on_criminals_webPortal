...
<table>
    ...
    <?php for($i = 1; $i<=count($AllUser); $i++){ 
      ...
      <tr id="<?php echo $id;?>" class="hidess">
        ...
        <td><a id="<?php echo $AllUser[$i]['OrganizationId'];?>" onclick="CallPopUp(<?php echo $AllUser[$i]['OrganizationId'];?>,<?php echo $is_admin;?>)"  title="Lorem ipsum dolor sit amet" ><img src="<?php echo base_url();?>/assets/template/default/images/editicon.png" title="Edit This User" /></a></td>
      </tr>
