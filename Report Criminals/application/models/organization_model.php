...
class Organization_Model extends __Base_Model
{
	...
	public function __construct(	$OrganizationId=null,$Email=null,$Password=null,$City=null,$State=null,$Zip=null,$Address=null,$Mobile=null,$PhotoPath=null,
	...
	public function save( $data = array() )
    {
        if(count($data)==0)
        {
			 ...
			 */
				...
				{
					if(!is_null($this->$name) AND $name!= '_parent_name' AND $name!='OrganizationId')
					{
						$data[$name]=$this->$name;
					}
				}
        ...
        else
        {
            ...
            $this->db->where('OrganizationId', $this->UserId);
    ...
    */
	...
	public function getOrganizationByUserId($OrganizationUniqueId)
	{
		$sql    =   "SELECT * FROM ".$this->getTableName()." where OrganizationUniqueId = '".$OrganizationUniqueId."'";
